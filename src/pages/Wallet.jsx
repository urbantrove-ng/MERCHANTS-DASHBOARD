...
export default function Wallet() {
  ...
  return (
    <div className="relative grid gap-[2rem] lg:w-[812px] h-[100vh] scrollbar-thumb-rounded-full scrollbar-track-rounded-full lg:scrollbar scrollbar-thumb-primaryOne scrollbar-track-primaryTwo overflow-y-scroll max-h-[75vh] lg:h-[90vh] justify-center lg:py-6 font-inter">
      <div className="fixed top-[10.6rem] sm:top-[9.3rem] right-0 z-10">
        <DisplaySideBar />
      </div>
      <div className="flex justify-between items-center lg:gap-[8rem] w-[300px] lg:w-[700px] sm:w-[83vw] h-[80px] lg:h-[100px] rounded-[10px] py-[0.5rem] px-[3rem] sm:px-[1rem] bg-gradient-to-r from-[rgba(233,230,206,1)] to-[rgba(151,173,177,1)]">
