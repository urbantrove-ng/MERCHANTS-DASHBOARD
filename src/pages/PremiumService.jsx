  ...
  return (
    <div className="grid gap-[1rem] mt-[10rem] overflow-y-auto max-h-[80vh] justify-center py-[3rem] px-[1rem] font-inter">
      <div className="w-[45rem] rounded-[10px] py-[0.5rem] px-[1rem] bg-gradient-to-r from-[rgba(233,230,206,1)] to-[rgba(151,173,177,1)]">
        <h1 className="font-[600] text-[1.5rem]">Premium</h1>
      </div>
      <div className="px-[3rem] mt-[2rem]">
        <h1 className="text-[1.2rem] mb-[1rem] ">Billing Plan</h1>
        <div className="px-[1rem] flex gap-[2rem]">
          <div
            className="border-[1px] border-primaryOne w-[17rem] py-[2rem] text-center rounded-[25px] cursor-pointer"
            onClick={() => handleContentClick("Basic")}
          >
            <img src={greenegg} alt="" className="m-auto" />
            <h1 className="text-[1.1rem] font-[100]">Billed Monthly</h1>
            <h1 className="text-[#836427] uppercase text-[2rem]">Basic</h1>
            <h1 className="text-primaryOne text-[3rem]">₦12500</h1>
            <ul className="text-left ml-[1.8rem]">
          ...
          >
            ...
            <h1 className="text-[1.1rem] font-[100]">Billed Monthly</h1>
            <h1 className="text-[#836427] uppercase text-[2rem]">Premium</h1>
            <h1 className="text-primaryOne text-[3rem]">₦15000</h1>
            <ul className="text-left ml-[1.8rem]">
              <li className="flex items-center gap-[0.5rem]">
                <span className="w-[0.7rem] h-[0.7rem] bg-primaryTwo rounded-[10rem]"></span>
                Maximum of 10 ads
        ...
        <div className="mt-[2rem] px-[1.5rem] font-sans">
            ...
            <>
              ...
              <div className="bg-primaryTwo px-[0.4rem] rounded-[5px]">
                <div className="flex justify-between border-b-[1px] border-[#d4d4d8] py-[0.6rem] px-[0.4rem]">
                  <h1 className="font-[700] text-[1.6rem]">Total</h1>
                  <h1 className="font-[700] text-[1.6rem]">₦12500</h1>
                </div>
                <h1 className="py-[0.6rem] text-[1.2rem] font-[300]">
          ...
          {selectedContent === "Premium" && (
            <>
              ...
              <div className="bg-primaryTwo px-[0.4rem] rounded-[5px]">
                <div className="flex justify-between border-b-[1px] border-[#d4d4d8] py-[0.6rem] px-[0.4rem]">
                  <h1 className="font-[700] text-[1.6rem]">Total</h1>
                  <h1 className="font-[700] text-[1.6rem]">₦15000</h1>
                </div>
                <h1 className="py-[0.6rem] text-[1.2rem] font-[300]">
      ...
      <div className="w-[45rem] mt-[3rem] rounded-[10px] py-[0.5rem] px-[1rem] bg-gradient-to-r from-[rgba(233,230,206,1)] to-[rgba(151,173,177,1)]">
        <h1 className="font-[600] text-[1.5rem]">Service</h1>
      </div>
      <form action="" className="px-[4rem] grid">
        <label htmlFor="" className="text-[1.3rem] text-[#444B59]">
          Enter Amount
        </label>
        <input
          type="number"
          className="border-primaryOne border-[2px] w-[25rem] py-[1rem] px-[0.4rem] focus:outline-none rounded-[10rem]"
        />
