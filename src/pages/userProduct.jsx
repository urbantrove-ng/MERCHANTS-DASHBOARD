...
export default function userProduct() {
  return (
    <div className="relative grid gap-[1rem] mt-[10rem] sm:mt-[8.5rem] scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar scrollbar-thumb-slate-700 scrollbar-track-primaryTwo overflow-y-scroll max-h-[80vh] lg:max-h-[90vh] justify-center py-[3rem] px-[1rem] sm:px-[0.4rem] font-inter">
      ...
      <div className="grid justify-center w-[47vw] lg:w-[40rem] sm:w-[82vw] bg-white px-[2rem] sm:px-[0.3rem] py-[1rem] rounded-[10px]">
        ...
        <div className="flex sm:grid sm:grid-cols-2 gap-[1rem] mt-[1rem]">
          {data.map((data, index) => {
            ...
            return (
              <div
                key={index}
                className="w-[13rem] lg:w-[11.5rem] sm:w-[37.5vw] flex bg-primaryTwo rounded-[10px] border-primaryOne border-[1px]"
              >
                ...
                <div className="grid gap-[0.3rem] m-auto sm:text-[0.8rem] text-center">
                  ...
                  <h1 className="text-center text-[0.9rem] sm:text-[0.7rem]">
                    {status}
                  </h1>
                </div>
              </div>
      ...
      <div className="w-[47vw] lg:w-[40rem] sm:w-[82vw] rounded-[10px] py-[0.5rem] px-[1rem] bg-gradient-to-r from-[rgba(233,230,206,1)] to-[rgba(151,173,177,1)]">
        <h1 className="font-[600] text-[1.5rem] sm:text-[1.2rem]">
          Add Products
        </h1>
      </div>
      <div className="flex justify-center gap-[2rem] sm:gap-[0.5rem] w-[47vw] lg:w-[40rem] sm:w-[82vw] bg-white px-[2rem] py-[1rem] rounded-[10px]">
        <div>
      ...
      <div className="flex justify-center gap-[2rem] w-[47vw] lg:w-[40rem] sm:w-[82vw] bg-white px-[2rem] py-[1rem] rounded-[10px]">
        <form action="">
          <div className="mb-[0.7rem]">
            <input
              type="text"
