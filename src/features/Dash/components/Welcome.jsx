  ...
  return (
    <div className="mt-[9rem]">
      <div
        ...
        } flex gap-[1px] w-[40rem] h-[15rem] bg-gradient-to-br from-[rgba(208,212,197,1)] to-[rgba(151,173,177,1)] mt-[-10rem] relative rounded-[10px]`}
      >
        <div className="w-[12rem] h-[16rem] ml-[1rem] mt-[-1.6rem]">
        ...
        <div className="grid w-[25rem] h-[10rem] py-[0.5rem] mt-[2rem] ml-[1.5rem]">
          <h1 className="text-[#1A1A1A] text-[0.9rem]">Hi, Fatima Yusuf</h1>
          <h1 className="font-[600] text-[2rem]">Welcome to Urban Trove</h1>
